...
class ProductDetails extends BaseModel {
  ...
  bool? get isInUserWishList =>
      _isInUserWishList == null ? false : _isInUserWishList;

  bool? get isInUserPriceAlert =>
      _isInUserPriceAlert == null ? false : _isInUserPriceAlert;

  bool? get isInUserAlertMe =>
      _isInUserAlertMe == null ? false : _isInUserAlertMe;
  ...
  List<Specifications> get coinGradeSpecification {
    return _coinGradeSpecification
        .where((element) => element.key != "Header" && element.key != "Footer")
        .toList();
  }

  Specifications? get coinHeaderSpecification {
    return _coinGradeSpecification
        .singleWhereOrNull((element) => element.key == "Header");
  }

  Specifications? get coinFooterSpecification {
    return _coinGradeSpecification
        .singleWhereOrNull((element) => element.key == "Footer");
  }
  ...
  @override
  ProductDetails fromJson(json) => ProductDetails.fromJson(json);
  ...
  ProductDetails.fromJson(Map<String, dynamic> json) {
    ...
    productNotes = json['product_notes'] == null
        ? null
        : json['product_notes'].cast<String>();
