...
class ProductTextStyle {
  ...
  static const TextStyle _titleStyle = TextStyle(fontWeight: FontWeight.w500, color: Color(0xff202020));
  static const TextStyle _priceStyle = TextStyle(fontWeight: FontWeight.w600, color: Color(0xff202020));
  static const TextStyle _strikedPriceStyle = TextStyle(fontWeight: FontWeight.normal, color: Color(0xff202020));
  ...
  static TextStyle strikedPrice(int gridCol, {Color color = const Color(0xff202020)}){
