                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(item!.name!,
                            ...
                            style: ProductTextStyle.title(2, color: AppColor.black)
                        ),
                        ...
                        if (type == ProductItemCardType.AlertMe)
                          Padding(
                            ...
                            child: Text("Quantity: ${detail.requestedQty}", textScaleFactor: 1, style: AppTextStyle.subtitle,),
                          )
                        else if (type == ProductItemCardType.PriceAlert)
                          Padding(
                            padding: const EdgeInsets.only(top: 10, bottom: 15),
                            child: Text("Your Price: ${detail.formatedYourPrice}", textScaleFactor: 1, style: AppTextStyle.subtitle,),
                          )
            ...
            SizedBox(
                child: MaterialButton(
                  ...
                  onPressed: (){
                    ...
                    children: [
                      Text("Edit", textScaleFactor: 1, style: AppTextStyle.text,),
                    ],
                  ),),
              width: double.infinity,
            ...
            SizedBox(
              ...
              child: MaterialButton(
                onPressed: (){
                  ...
                  children: [
                    Text("Remove", textScaleFactor: 1, style: AppTextStyle.text,),
                  ],
                ),
              ),
            )
...
class _PriceSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (item!.productAction == ProductInfoDisplayType.addToCart) {
      List<Widget> priceList = [
        Text(
          ...
          style: ProductTextStyle.price(2, color: AppColor.black)
            .copyWith(color: item!.pricing!.strikeThroughEnabled! ? const Color(0xffC30000) : AppColor.primaryDark),textScaleFactor: 1,),

        if(item!.pricing!.strikeThroughEnabled!)
          Text(item!.pricing!.formattedOldPrice!,textScaleFactor: 1,
        ...
        children: [
          ...
          if(item!.pricing!.badgeText != null)
            Container(
              ...
              alignment: alignment,
              child: Text(item!.pricing!.badgeText!,
          ...
          if(item!.pricing!.strikeThroughEnabled!)
            Container(
              padding: const EdgeInsets.only(top: 5),
              alignment: alignment,
              child: Text(item!.pricing!.discountText!,
                textAlign: TextAlign.center,textScaleFactor: 1,
                style: ProductTextStyle.badge(2, color: AppColor.black),
              ),
            ),
    ...
    return Container(
        alignment: alignment,
        child: Text(item!.availabilityText!, textAlign: TextAlign.left,textScaleFactor: 1, style: AppTextStyle.title.copyWith(color: AppColor.red, fontSize: 16),)
    );
  }
