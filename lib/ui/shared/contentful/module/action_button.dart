...
class ActionButtonItem extends StatelessWidget {
  ...
  onTap(){
    locator<NavigationService>().pushNamed(settings!.targetUrl,);
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (settings!.style == ActionButtonStyle.link) {
      return InkWell(
          ...
          child: Row(
            ...
            children: [
              Text(settings!.labelText!, textScaleFactor: 1, style: settings!.textStyle.copyWith(color: settings!.textColor == null ? textColor : settings!.labelTextColor,)),
    ...
    return MaterialButton(
      ...
      child: _buildDynamicPositionWrapper(
        children: [
          Text(
            settings!.labelText!,
            textScaleFactor: 1,
          ...
          if (settings!.hasIcon!)
            Icon(Icons.navigate_next, color: settings!.buttonTextColor,)
        ]
      ),
    );
