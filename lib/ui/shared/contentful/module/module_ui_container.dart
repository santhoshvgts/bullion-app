      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
              ...
              image: vm.displaySetting!.hasBackgroundImage ? DecorationImage(
          ...
          child: Column(
            children: [
              ...
              if (!vm.setting!.hasHeaderSection && vm.setting!.displaySettings!.itemDisplaySettings.displayType == DisplayStyle.standard)
                VerticalSpacing.custom(value: vm.displaySetting!.itemDisplaySettings.cardPadding),
    ...
    return Column(
      children: [
        ...
        if (viewModel.setting!.metaData!.saleEndDate != null)
          Text("Ends In : ${viewModel.endTime.toString()}",
            textScaleFactor: 1,
            textAlign: UIAlignment.textAlign(viewModel.displaySetting!.titleAlignment),
        ...
        if (viewModel.setting!.metaData!.saleStartDate != null)
          Text("Sales Starts on : ${viewModel.setting!.metaData!.saleStartDate.toString()}",
            textScaleFactor: 1,
            textAlign: UIAlignment.textAlign(viewModel.displaySetting!.titleAlignment),
            style: AppTextStyle.subtitle.copyWith(
                fontSize: AppFontSize.subtitleByValue("small"),
