  ...
  Widget build(BuildContext context, StandardViewModel viewModel) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: viewModel.itemDisplaySettings.backgroundColor, borderRadius: BorderRadius.circular(20), border: Border.all(color: viewModel.itemDisplaySettings.textColor, width: 0.8)),
        child: Text(
          item.title!,
          textScaleFactor: 1,
          style: AppTextStyle.text.copyWith(color: viewModel.itemDisplaySettings.textColor),
        ),
      ),
    );
  }
