  ...
  Widget build(BuildContext context,) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: false,
        title: Image.asset(Images.appLogo, height: 18,),
        actions: const [
          CartButton()
        ],
      ...
      child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Image.asset(Images.search,width: 15, color: Colors.white,),

              HorizontalSpacing.d10px(),

              Padding(
                padding: const EdgeInsets.only(bottom:2.0),
                child: Text("Search Products and Deals",
                  style: AppTextStyle.text.copyWith(fontSize: 16, color: Colors.white,),
